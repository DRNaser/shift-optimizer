// =============================================================================
// SOLVEREIGN BFF - Dispatcher Lock Run
// =============================================================================
// POST /api/platform/dispatcher/runs/[id]/lock
//
// Locks a published run for export.
// Same gates as publish, plus lock_enabled check.
// =============================================================================
...
export async function POST(
  ...
  // Call backend
  const response = await dispatcherApi.lockRun(tenantCode, siteCode, runId, {
